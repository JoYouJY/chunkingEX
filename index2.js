...
function JsCallFunction(type, arg_string){
  ...
  if(type == call_type.CONNECT){    
    ...
    console.log("[____] call_type.GOOGLE_SAVE_INFO");
...
var firebaseConfig = {
    apiKey: "AIzaSyB6djqGHzYlE2osA5wZuucbRt7YqmZtLPk",
    authDomain: "fa-rpg.firebaseapp.com",
    projectId: "fa-rpg",
    storageBucket: "fa-rpg.firebasestorage.app",
    messagingSenderId: "1009873370930",
    appId: "1:1009873370930:web:5c530e76d24eb37535212b",
    measurementId: "G-B81YDYZ0PG"
};
...
async function SignInGoogle(){
  ...
  console.log("[____] user.uid:", user.uid);
  if (user) {
    GetUserInfo(user);
  } 
}
...
async function GoogleSaveInfo(splited_text){
  ...
  console.log("[____] GoogleSaveInfo", splited_text);
